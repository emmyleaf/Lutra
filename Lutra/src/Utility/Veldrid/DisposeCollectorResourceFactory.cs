// Used from Veldrid.Utilities under the MIT license.
...
{
    public class DisposeCollectorResourceFactory(ResourceFactory factory, DisposeCollector disposeCollector) : ResourceFactory(factory.Features)
    {
