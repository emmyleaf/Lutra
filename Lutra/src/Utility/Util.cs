...
{
    /// <summary>
    /// Main utility function class. Various useful functions for 2d game development. Mostly from Otter!
    /// </summary>
    public static class Util
    {
        ...
        public static float LerpSet(float amount, params float[] numbers)
        {
            ...
            return MathHelper.Lerp(numbers[fromIndex], numbers[toIndex], lerp);
        }
		...
		public static Color LerpColor(Color value1, Color value2, float amount)
        {
        ...
        /// <summary>
        /// Clamps an integer value inside a range.
        /// </summary>
        ...
        /// <summary>
        /// Clamps a float value inside a range.
        /// </summary>
        /// <param name="value">The value to clamp.</param>
        /// <param name="min">Min clamp.</param>
        /// <param name="max">Max clamp.</param>
        ...
        /// <returns>True if the point is in the rectangle.</returns>
        public static bool InRect(float x, float y, RectInt rect)
        {
        ...
        /// <param name="rect">The rectangle.</param>
        /// <returns>The distance.  Returns 0 if the point is within the rectangle.</returns>
        public static float DistancePointRect(float px, float py, RectInt rect)
        {
        ...
        /// <summary>
        /// Convert a list of generic enums to an array of ints.
        /// </summary>
        /// <param name="enums">The enums to convert.</param>
        /// <returns>An array of ints.</returns>
        public static int[] EnumToIntArray<TEnum>(List<TEnum> enums)
        where TEnum : Enum
        {
        ...
        {
            DebugConsole.Instance?.LogInfo(str);
        }

        public static void LogWarning(string str)
        {
            DebugConsole.Instance?.LogWarning(str);
        }

        public static void LogError(string str)
        {
            DebugConsole.Instance?.LogError(str);
        }

        public static void LogQuiet(string str)
        {
            DebugConsole.Instance?.LogQuiet(str);
        }

        [Obsolete("Deprecated. Please use template strings and log level methods instead.", false)]
        public static void Log(string str, params object[] obj)
        {
            DebugConsole.Instance?.Log(string.Format(str, obj));
        }

        [Obsolete("Deprecated. Please use template strings and log level methods instead.", false)]
        public static void LogTag(string tag, string str)
        {
            DebugConsole.Instance?.Log($"[{tag} {str}]");
        }

        [Obsolete("Deprecated. Please use template strings and log level methods instead.", false)]
        public static void LogTag(string tag, string str, params object[] obj)
        {
            DebugConsole.Instance?.Log($"[{tag} {string.Format(str, obj)}]");
        }
