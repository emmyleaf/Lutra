...
{
    /// <summary>
    /// Class that is used for storing strings, ints, floats, or bools with keys of enum or string.
    /// The saver can output data in an semi-encrypted format, and also an editable config file format.
    /// </summary>
    public class DataSaver
    {
        ...
        /// </summary>
        /// <param name="game">The game with GameFolder set.</param>
        public DataSaver(Game game)
        {
            DefaultPath = game.GameFolderFullPath;
