...
/// <summary>
/// Instanced Graphic that renders part of a sprite sheet, but does not automatically animate it.
/// </summary>
public class InstancedImageSet : InstancedImage
{
    ...
    /// <summary>
    /// Create a new InstancedImageSet from a file path for a texture.
    /// </summary>
    ...
    public InstancedImageSet(string source, int width, int height) : base(source)
    {
        Initialize(width, height);
    }

    /// <summary>
    /// Create a new InstancedImageSet from a LutraTexture.
    /// </summary>
    /// <param name="texture">The LutraTexture to use for the image sheet.</param>
    /// <param name="width">The width of each cell on the image sheet.</param>
    /// <param name="height">The height of each cell on the image sheet.</param>
    public InstancedImageSet(LutraTexture texture, int width, int height) : base(texture)
    {
        Initialize(width, height);
    }
